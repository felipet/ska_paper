...
\input{paper_src/sec/introduction}

\section{The SKA telescope}

\input{paper_src/sec/ska-telescope.tex}

\section{The White Rabbit synchronization protocol}

\input{paper_src/sec/white-rabbit.tex}

\section{The PPS distribution system for SKA}

\input{paper_src/sec/pps-system-ska.tex}

\section{Experiments}

\input{paper_src/sec/experiments}
...
\input{paper_src/sec/acknowledgments.tex}
