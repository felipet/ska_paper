...
WR solution in the SKA timing distribution. The next experiment evaluates 
...
a constant value, $\alpha$, which expresses the ratio between propagation times 
...
mid-distance links, in laboratory conditions, $\alpha$ variation is nearly negligible and 
the current link model behaves very well. However, the WR network in SKA will be formed 
