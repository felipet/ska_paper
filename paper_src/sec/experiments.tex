...
system. First we show some results from the evaluation of the developed system and we compared those results with another WR node available nowadays. Next we present an experiment that try to emulate a example of WR network like the 
