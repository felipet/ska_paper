...
\klyonelnote{En esta tabla no están el MDEV y TDEV de las dos últimas filas ¿Es 
eso normal?}
\ftglnote{Es por el tipo de cálculo que se hace para dichos estadísticos, que 
consume más datos que en el caso de las varianzas. Como quedaba raro y además 
redundante con gráfica y tabla he decidido mostrar solo los valores más 
relevantes.}
...
\klyonelnote{Comentarios acerca de las figuras 9a,b y c. En general no las veo 
mal, es cierto que el visor de PDF hace cosas raras con el renderizado y hasta 
que no haces zoom no se ve bien del todo. Sin embargo, la 9c si la veo algo 
pequeña si te fijas en las letras de los ejes se ven un poco regular incluso 
ampliando. El resto creo que no están mal en cuanto a resolución.}
...
TDEV and MTIE values have been calculated by octaves \klyonelnote{¿Esto de 
"octaves" está bien?} \ftglnote{Sí, quiere decir doblando el valor, en lugar de 
multiplicando por 10, lo que nos hace ganar algunos puntos más.}, the numerical 
values can 
