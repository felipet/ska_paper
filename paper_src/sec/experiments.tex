...
\begin{itemize}
    ...
    \begin{itemize}
        \item Small form-factor pluggable transceptors (SFPs) 
        \textcolor{teal}{sfps ya definidos}to establish the 
...
nodes that need to be synchronized for the SKA: around 250 endpoints 
\textcolor{teal}{se decanta por usar -} that 
...
endpoint \textcolor{teal}{se decanta por usar -}. This configuration allows 
synchronizing up to 306 WR nodes with an 
