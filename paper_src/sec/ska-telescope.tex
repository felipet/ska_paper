...
Australia/New Zealand) it will be one of the greatest physics machines of 21st 
Century and, when completed, one of the world’s engineering marvels \gutinote{frases como world's engineering marvels creo que deben quedar fuera de artículos científicos}. It will be 
...
The key science goals for this instrument are: \gutinote{estos bullet points creo que podrían quitarse}
...
The scale of the SKA Telescope \gutinote{SKA Telescope, la T en algunos sitios está en mayúscula y en otros no, revisad eso} represents a huge leap forward in both 
...
\gutinote{la figura no está referenciada en el texto}
\textcolor{red}{[hay que revisar todo el tema de acrónimos, está muy mezclado todo]}
...
Note that if the offset frequency scheme is to be applied to all SKA1-MID dishes, an additional 64 STFR \gutinote{no se dice antes lo que es STFR?} endpoints will be needed in SKA1-MID. This provides between 182 and 246 endpoints to synchronize. 
