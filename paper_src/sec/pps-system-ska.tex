...
\textcolor{teal}{The Zynq-7000 SoC chosen is the XC7Z015. We will expose the 
...
by the design in Hardware Description Language, HDL, which includes the major 
...
be connected to standard PTP devices via copper links. The WR-NIC drivers allow 
the communication and forwarding of packets between the copper Ethernet 
interfaces and the fibre ones used by the WR network. Other relevant connection 
